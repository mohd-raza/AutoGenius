...
const Questions = () => {
  return (
    <div className="font-body pt-24 flex flex-col justify-center items-center">
      ...
      <div>
        <button
          type="button"
          class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mt-4 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
        >
          Recommend
        </button>
      </div>
