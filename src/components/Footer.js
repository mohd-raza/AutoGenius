  ...
  return (
    <div className="text-white font-body">
      <footer
        ...
        className="bg-[#111827] lg:grid lg:grid-cols-5 text-2xl font-semibold"
      >
        ...
        <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
            <div>
              <p>
                <span className="tracking-wide text-white uppercase text-2xl">
                  Email us
                </span>

                <a
                  href="#"
                  className="block text-2xl font-medium text-white hover:opacity-75 sm:text-xl"
                >
          ...
          <div className="pt-12 mt-12 border-t border-gray-100">
            <div className="sm:flex sm:items-center sm:justify-between">
              ...
              <p className="mt-8 text-xs text-white sm:mt-0">
                &copy; 2023. Enemies Of Syntaxx. All rights reserved.
              </p>
            </div>
          </div>
        </div>
